...
public class Prj3Part1_Without_MRV {

	public static void main(String[] args) {
		/*
		 * String[] people = {"Roberta","Thelma","Steve","Pete"};
		 * HashSet<String> ps = new HashSet<String>(Arrays.asList(people));
		 * System.out.println(ps);
		 */
		Prj3Part1_Without_MRV test = new Prj3Part1_Without_MRV();
		test.playGame();
	}
	...
	private boolean backtracking(HashSet<String> domains, Hashtable<String, HashSet<String>> name_assignment,
		...
		for (String name : name_assignment.keySet()) {
			//get the name that has the MRV: minimum minimum remaining remaining values
			if (name_assignment.get(name).size() < 2) {// then this peole is not
														// fully assigned yet
				//System.out.println("Start to assign: " + name + " at layer: " + layer);
				...
				// just return false
				//System.out.println("could not find assignemnt for current people: " + name + " at layer: " + layer);
				return false;
			}
		}
